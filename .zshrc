...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(status os_icon ssh root_indicator dir dir_writable vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(command_execution_time rvm time)
...
# alias h="hsi"
alias test="./php ./vendor/bin/phpunit -d memory_limit=2048M --filter "
alias phoenix="cd ~/code/phoenix"
alias plat="cd ~/code/platform"
alias platform="plat"
...
# Display what alias was just executed
_-accept-line () {
    emulate -L zsh
    local -a WORDS
    WORDS=( ${(z)BUFFER} )
